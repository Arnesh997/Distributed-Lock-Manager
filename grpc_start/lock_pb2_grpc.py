...
class LockServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendHeartbeat = channel.unary_unary(
                '/lock_service.LockService/SendHeartbeat',
                request_serializer=lock__pb2.HeartbeatRequest.SerializeToString,
                response_deserializer=lock__pb2.HeartbeatResponse.FromString,
                _registered_method=True)
        self.SyncState = channel.unary_unary(
                '/lock_service.LockService/SyncState',
                request_serializer=lock__pb2.StateSync.SerializeToString,
                response_deserializer=lock__pb2.Response.FromString,
                _registered_method=True)
        self.Election = channel.unary_unary(
                '/lock_service.LockService/Election',
                request_serializer=lock__pb2.ElectionRequest.SerializeToString,
                response_deserializer=lock__pb2.ElectionResponse.FromString,
                _registered_method=True)
        self.Coordinator = channel.unary_unary(
                '/lock_service.LockService/Coordinator',
                request_serializer=lock__pb2.CoordinatorNotification.SerializeToString,
...
def add_LockServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendHeartbeat': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=lock__pb2.HeartbeatRequest.FromString,
                    response_serializer=lock__pb2.HeartbeatResponse.SerializeToString,
            ),
            'SyncState': grpc.unary_unary_rpc_method_handler(
                    servicer.SyncState,
                    request_deserializer=lock__pb2.StateSync.FromString,
                    response_serializer=lock__pb2.Response.SerializeToString,
            ),
            'Election': grpc.unary_unary_rpc_method_handler(
                    servicer.Election,
                    request_deserializer=lock__pb2.ElectionRequest.FromString,
                    response_serializer=lock__pb2.ElectionResponse.SerializeToString,
            ),
            'Coordinator': grpc.unary_unary_rpc_method_handler(
                    servicer.Coordinator,
                    request_deserializer=lock__pb2.CoordinatorNotification.FromString,
...
class LockService(object):
    ...
    def SendHeartbeat(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/lock_service.LockService/SendHeartbeat',
            lock__pb2.HeartbeatRequest.SerializeToString,
            lock__pb2.HeartbeatResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def SyncState(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/lock_service.LockService/SyncState',
            lock__pb2.StateSync.SerializeToString,
            lock__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    def Election(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/lock_service.LockService/Election',
            lock__pb2.ElectionRequest.SerializeToString,
            lock__pb2.ElectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def Coordinator(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/lock_service.LockService/Coordinator',
            lock__pb2.CoordinatorNotification.SerializeToString,
